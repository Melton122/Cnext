...
copy /Y "%~dp0cnext-v3.5-windows\bin\cnext.exe" "%INSTALL_DIR%\bin\" >nul
if errorlevel 1 (
...
xcopy /E /Y /Q "%~dp0cnext-v3.5-windows\include\*" "%INSTALL_DIR%\include\" >nul

echo Copying examples...
xcopy /E /Y /Q "%~dp0cnext-v3.5-windows\examples\*" "%INSTALL_DIR%\examples\" >nul

echo Copying documentation...
xcopy /E /Y /Q "%~dp0cnext-v3.5-windows\docs\*" "%INSTALL_DIR%\docs\" >nul

echo Copying tests...
xcopy /E /Y /Q "%~dp0cnext-v3.5-windows\tests\*" "%INSTALL_DIR%\tests\" >nul

echo Copying launcher...
copy /Y "%~dp0cnext-v3.5-windows\cnext.bat" "%INSTALL_DIR%\" >nul
copy /Y "%~dp0cnext-v3.5-windows\INSTALL.txt" "%INSTALL_DIR%\" >nul
copy /Y "%~dp0cnext-v3.5-windows\README.md" "%INSTALL_DIR%\" >nul
copy /Y "%~dp0cnext-v3.5-windows\LICENSE" "%INSTALL_DIR%\" >nul
copy /Y "%~dp0cnext-v3.5-windows\CHANGELOG.md" "%INSTALL_DIR%\" >nul
copy /Y "%~dp0cnext-v3.5-windows\CONTRIBUTING.md" "%INSTALL_DIR%\" >nul
copy /Y "%~dp0cnext-v3.5-windows\Makefile" "%INSTALL_DIR%\" >nul
...
echo.
echo For more information, see %INSTALL_DIR%\INSTALL.txt
echo.
